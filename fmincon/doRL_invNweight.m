function [predictedResp, choiceProb, V] = doRL_decay(alle, p)
    ...
    for ei = 1:nTrials
        ...
        %V1 = V(mx(1), my(1));
        %V2 = V(mx(2), my(2));
        V1 = V(mx(1), my(1)) + invNW*(1/numVisits(mx(1), my(1)));
        V2 = V(mx(2), my(2)) + invNW*(1/numVisits(mx(2), my(2)));
       ...
       predictedResp(ei) = 2 - ( 1 ./ (1 + exp(-1*beta*(V1-V2))) );  
        ...
        numVisits(mx(moveChoice), my(moveChoice)) = numVisits(mx(moveChoice), my(moveChoice))+1;
